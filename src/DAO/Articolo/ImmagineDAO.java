...
public class ImmagineDAO implements IImmagineDAO{
    ...
    public int add(Immagine immagine) {
        int rowCount;
        sql = "INSERT INTO immagine (idImmagine, idArticolo, immagine) VALUES ('" + immagine.getIdImmagine() + "','" + immagine.getIdArticolo() + "','" + ImmagineBusiness.getInstance().getBlobByImage(immagine.getImage(),"png") + "');";
