...
public class CategoriaDAOTest {
    ...
    public void update() {
        ICategoriaDAO categoriaDAO = CategoriaDAO.getInstance();
        ICategoria newCategoria = new Categoria(9999, "Officina", null);
        categoriaDAO.update(newCategoria);
        Assert.assertEquals("Officina", categoriaDAO.findById(9999).getName());
        categoriaDAO.remove(newCategoria);
    }
}